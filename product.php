...
<head>
	...
	<title>Products &#8211; Super Fashion</title>
	<style type="text/css" data-type="vc_shortcodes-custom-css">
	.vc_custom_1477991881291 {
		padding-top: 84px !important;
	}
	
	.vc_custom_1542365306095 {
		padding-top: 81px !important;
		padding-bottom: 41px !important;
	}
	
	.vc_custom_1542177843715 {
	...
	.page-id-466.disabled_footer_top .footer_top_holder,
	.page-id-466.disabled_footer_bottom .footer_bottom_holder {
		display: none;
	}
	</style>
...
<body class="page-template page-template-full_width page-template-full_width-php page page-id-466 bridge-core-1.0.4  qode_grid_1300 footer_responsive_adv hide_top_bar_on_mobile_header qode-child-theme-ver-1.0.0 qode-theme-ver-18.0.6 qode-theme-bridge qode_header_in_grid wpb-js-composer js-comp-ver-6.0.5 vc_responsive" itemscope itemtype="http://schema.org/WebPage">
				...
				<div class="content_inner  ">
									...
									<div class="container_inner clearfix">
										<div class="title_subtitle_holder">
											<div class="title_subtitle_holder_inner">
												...
												<h4 class="subtitle">Fresh. Perfect. Reasonably priced</h4> </div>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="full_width">
						<div class="full_width_inner">
							...
							<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1542365306095 grid_section" style=' text-align:left;'>
									...
									<div class='section_inner_margin clearfix'>
											...
											<div class="vc_column-inner">
												<div class="wpb_wrapper">
													<div class="qode-crossfade-images">
														<a class="qode-cfi-link" href="mens.php" target="_self"></a>
														<div class="qode-cfi-img-holder" style="	max-height:583px;background-color: ;">
															<a href="men.php"> <img src="file/wp-content/uploads/2019/03/pexels-photo-1043474.jpeg" alt="initial image" style="height:600px;" /></a>
															
														</div>
														<div class="qode-cfi-title-holder">
															<h3 class="qode-cfi-title">Mens</h3> </div>
													</div>
												</div>
											</div>
										</div>
										<div class="wpb_column vc_column_container vc_col-sm-6">
											<div class="vc_column-inner">
												<div class="wpb_wrapper">
													<div class="qode-crossfade-images">
														<a class="qode-cfi-link" href="women.php" target="_self"></a>
														<div class="qode-cfi-img-holder" style="	max-height:584px;
					background-color: ;
			">
															 <img src="file/wp-content/uploads/2019/03/pexels-photo-5480691.jpeg" alt="initial image" style="height:600px;" />
															
														</div>
														<div class="qode-cfi-title-holder">
															<h3 class="qode-cfi-title">Womens</h3> </div>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1542177843715 grid_section" style=' text-align:left;'>
								<div class=" section_inner clearfix">
									<div class='section_inner_margin clearfix'>
										<div class="wpb_column vc_column_container vc_col-sm-6">
											<div class="vc_column-inner">
												<div class="wpb_wrapper">
													<div class="qode-crossfade-images">
														<a class="qode-cfi-link" href="kids.php" target="_self"></a>
														<div class="qode-cfi-img-holder" style="	max-height:584px;
					background-color: ;
			">
															 <img src="file/wp-content/uploads/2019/03/pexels-photo-4545966.jpeg" alt="initial image" style="height:600px;" />
																
															
														</div>
														<div class="qode-cfi-title-holder">
															<h3 class="qode-cfi-title">Kids</h3> </div>
													</div>
												</div>
											</div>
										</div>
										<div class="wpb_column vc_column_container vc_col-sm-6">
											<div class="vc_column-inner">
												<div class="wpb_wrapper">
													<div class="qode-crossfade-images">
														<a class="qode-cfi-link" href="fabric.php" target="_self"></a>
														<div class="qode-cfi-img-holder" style="	max-height:543px;
					background-color: ;
			">
															 <img src="file/wp-content/uploads/2019/03/pexels-photo-3618344.jpeg" style="height:600px;" alt="initial image" />
																
														</div>
														<div class="qode-cfi-title-holder">
															<h3 class="qode-cfi-title" style="margin-top:60px;">Fabrics</h3> </div>
													</div>
												</div>
											</div>
										</div>
