...
<head>
	...
	< <title>Certifications &#8211; Super Fashion</title>
		<style type="text/css" data-type="vc_shortcodes-custom-css">
		.vc_custom_1589526589055 {
			padding-top: 84px !important;
		}
		
		.vc_custom_1589526744550 {
		...
		.page-id-449.disabled_footer_top .footer_top_holder,
		.page-id-449.disabled_footer_bottom .footer_bottom_holder {
			display: none;
		}
		</style>
...
<body class="page-template page-template-full_width page-template-full_width-php page page-id-449 bridge-core-1.0.4  qode_grid_1300 footer_responsive_adv hide_top_bar_on_mobile_header qode-child-theme-ver-1.0.0 qode-theme-ver-18.0.6 qode-theme-bridge qode_header_in_grid wpb-js-composer js-comp-ver-6.0.5 vc_responsive" itemscope itemtype="http://schema.org/WebPage">
	...
	<div class="wrapper">
		<div class="wrapper_inner">
					...
					<div class="content_inner  ">
										...
										<div class="container_inner clearfix">
											<div class="title_subtitle_holder">
												<div class="title_subtitle_holder_inner">
													...
													<h4 class="subtitle">Driven by Values, Technology & Responsibility</h4> </div>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="full_width">
							<div class="full_width_inner">
								<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589526589055 grid_section" style=' text-align:left;'>
			...
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p><strong>Certification/Organization : Worldwide Responsible Apparel Production Certificate (WRAP)</strong></p>
															</div>
														</div>
			...
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_single_image wpb_content_element vc_align_left">
															<div class="wpb_wrapper">
																...
																<img width="500" height="226" src="file/wp-content/uploads/2020/03/Worldwide-Responsible-Apparel-Production-Certificate-WRAP-1.jpg" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 500px) 100vw, 500px" /></div>
															</div>
														</div>
														<div class="vc_empty_space" style="height: 15px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p><strong>Initiative : </strong>Awarded for ensuring apparel production under lawful, humane and ethical conditions.</p>
															</div>
														</div>
													</div>
												</div>
			...
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p><strong>Certification/Organization : SMETA<br /></strong></p>
															</div>
														</div>
														<div class="vc_empty_space" style="height: 15px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_single_image wpb_content_element vc_align_left">
															<div class="wpb_wrapper">
																<div class="vc_single_image-wrapper vc_box_border  vc_box_border_grey">
																<img width="500" height="226" src="file/wp-content/uploads/2020/03/smeta  logo.png" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 500px) 100vw, 500px" /></div>
															</div>
														</div>
														<div class="vc_empty_space" style="height: 15px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p><strong>Initiative : </strong>For good working conditions of workers.</p>
															</div>
														</div>
													</div>
												</div>
			...
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p><strong>Certification/Organization : Global Organic Textile Standard (GOTS)</strong></p>
															</div>
														</div>
														<div class="vc_empty_space" style="height: 15px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_single_image wpb_content_element vc_align_left">
															<div class="wpb_wrapper">
																<div class="vc_single_image-wrapper vc_box_border  vc_box_border_grey"><img width="500" height="226" src="file/wp-content/uploads/2020/03/Global-Organic-Textile-Standard-GOTS-1.jpg" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 500px) 100vw, 500px" /></div>
															</div>
														</div>
														<div class="vc_empty_space" style="height: 15px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p><strong>Initiative : </strong>For organic cotton products.</p>
															</div>
														</div>
													</div>
												</div>
			...
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p><strong>Certification/Organization: CTPAT</strong></p>
															</div>
														</div>
														<div class="vc_empty_space" style="height: 15px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_single_image wpb_content_element vc_align_left">
															<div class="wpb_wrapper">
																<div class="vc_single_image-wrapper vc_box_border  vc_box_border_grey">
																<img width="405" height="227" src="file/wp-content/uploads/2020/03/ctpat.png" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 405px) 100vw, 405px" /></div>
															</div>
														</div>
														<div class="vc_empty_space" style="height: 15px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p><strong>Initiative : </strong>For raw, semi-finished as well as finished textile products at all processing levels and accessory materials utilised.</p>
															</div>
														</div>
													</div>
												</div>
			...
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p><strong>Certification/Organization: International Organization for Standardization (ISO)</strong></p>
															</div>
														</div><img width="500" height="226" src="file/wp-content/uploads/2020/03/International-Organization-for-Standardization-ISO-1.jpg" class="vc_single_image-img attachment-full" alt="" sizes="(max-width: 500px) 100vw, 500px" />
														<div class="vc_empty_space" style="height: 15px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
														</div>
														<div class="vc_empty_space" style="height: 15px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p><strong>Initiative : </strong>ISO 9001 : 2000 Certifications for Environment Management Systems.</p>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="wpb_column vc_column_container vc_col-sm-6">
												<div class="vc_column-inner">
													<div class="wpb_wrapper">
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p><strong>Certification/Organization: Ministry of Commerce and Trade</strong></p>
															</div>
														</div>
														<div class="vc_empty_space" style="height: 15px"><span class="vc_empty_space_inner">
														<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_single_image wpb_content_element vc_align_left">
															<div class="wpb_wrapper">
																<div class="vc_single_image-wrapper vc_box_border  vc_box_border_grey"><img width="500" height="226" src="file/wp-content/uploads/2020/03/Ministry-of-Commerce-and-Trade-1.jpg" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 500px) 100vw, 500px" /></div>
															</div>
														</div>
														<div class="vc_empty_space" style="height: 15px"><span class="vc_empty_space_inner">
														<span class="empty_space_image"  ></span> </span>
