...
<head>
	...
	.page-id-1752.disabled_footer_top .footer_top_holder,
	.page-id-1752.disabled_footer_bottom .footer_bottom_holder {
		display: none;
	}
	</style>
		...
		<div class="wrapper_inner">
				...
				<div class="content_inner  ">
					...
					<div class="full_width">
						<div class="full_width_inner">
							<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589526863222 grid_section" style=' text-align:left;'>
											...
											<div class="vc_column-inner">
												<div class="wpb_wrapper">
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<h5 style="text-align: center;">A Semi-Vertically Integrated Circular Knit Manufacturer in India</h5> </div>
													</div>
												</div>
											</div>
										</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_single_image wpb_content_element vc_align_left">
														<div class="wpb_wrapper">
															<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="536" height="244" src="file/wp-content/uploads/2019/03/1610544261115.jpeg" class="vc_single_image-img attachment-full" alt="" sizes="(max-width: 536px) 100vw, 536px" /></div>
														</div>
													</div>
												</div>
											</div>
...
"To be globally reputed apparel manufacturing company through our continued Passion for excellence"
<br/><br/>
<h5>Mission</h5></br>
<ul>
<li> To achieve sustainable growth through operational excellence, innovation and ethical principles.</li>
<li>  To turn customer expectation to customer delight</li>
<li>  To nurture employees career growth and make SUPER FASHION a great place to work</li></ul>
														<p>
													</div>
												</div>
											</div>
...
<li> <div class="vc_row wpb_row section vc_row-fluid " style=' text-align:left;'>
