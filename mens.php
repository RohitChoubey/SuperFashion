...
<head>
	...
	<title>Mens &#8211; Super Fashion</title>
	...
	<a id="back_to_top" href="#"> <span class="fa-stack">
								...
								<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589525267693 grid_section" style=' text-align:left;'>
									<div class=" section_inner clearfix">
										...
										<?php 
											...
											$result = $db->query("SELECT * FROM product where category='men' ORDER BY id DESC LIMIT $start_from, $limit"); 
										?>
			...
			<span class="empty_space_image"  ></span> </span>
										...
										<?php
											...
											$result_db = mysqli_query($db,"SELECT COUNT(id) FROM product where category='men'"); 
											...
											for ($i=1; $i<=$total_pages; $i++) {
														  $pagLink .= "<li class='page-item'><a class='page-link' href='mens.php?page=".$i."'>".$i."</a></li>";	
											}
