...
<head>
	...
	<title>Kids &#8211; Super Fashion</title>
								...
								<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589525267693 grid_section" style=' text-align:left;'>
									<div class=" section_inner clearfix">
										...
										<?php 
											...
											$result = $db->query("SELECT * FROM product where category='women' ORDER BY id DESC LIMIT $start_from, $limit"); 
										?>
			...
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_single_image wpb_content_element vc_align_left">
															<div class="wpb_wrapper">
																...
																<img style ="height:600px;" src="uploads/<?php echo($item['img'])?>" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 634px) 100vw, 634px" /></div><br/>
															<?php 
																...
																<button class="product-item__action-button button 																?>
button--small button--primary" name = "delete" style="background-color:red; color:white;"><i class="fa fa-trash"></i>Delete Product</button>
															</form>
															<?php	
														}
																else{
										...
										<?php
											...
											$result_db = mysqli_query($db,"SELECT COUNT(id) FROM product where category='women'"); 
											...
											for ($i=1; $i<=$total_pages; $i++) {
														  $pagLink .= "<li class='page-item'><a class='page-link' href='women.php?page=".$i."'>".$i."</a></li>";	
											}
