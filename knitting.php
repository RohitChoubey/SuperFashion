...
<head>
	...
	<title>Knitting &#8211; Super Fashion</title>
	<style type="text/css" data-type="vc_shortcodes-custom-css">
	.vc_custom_1589521219214 {
		padding-top: 72px !important;
	}
	
	.vc_custom_1589458996906 {
	...
	.page-id-538.disabled_footer_top .footer_top_holder,
	.page-id-538.disabled_footer_bottom .footer_bottom_holder {
		display: none;
	}
	</style>
...
<body class="page-template page-template-full_width page-template-full_width-php page page-id-538 bridge-core-1.0.4  qode_grid_1300 footer_responsive_adv hide_top_bar_on_mobile_header qode-child-theme-ver-1.0.0 qode-theme-ver-18.0.6 qode-theme-bridge qode_header_in_grid wpb-js-composer js-comp-ver-6.0.5 vc_responsive" itemscope itemtype="http://schema.org/WebPage">
		...
		<div class="wrapper_inner">
					...
					<div class="content_inner  ">
										...
										<div class="container_inner clearfix">
											<div class="title_subtitle_holder">
												<div class="title_subtitle_holder_inner">
													<h1><span>Knitting</span></h1>
													<h4 class="subtitle">Knitting Perfection with a capacity to manufacture 40,000 MT of fabrics per annum.</h4> </div>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="full_width">
							<div class="full_width_inner">
								<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589521219214 grid_section" style=' text-align:left;'>
			...
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_single_image wpb_content_element vc_align_left">
															<div class="wpb_wrapper">
																<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="535" height="210" src="file/wp-content/uploads/2019/03/sKniting.jpeg" class="vc_single_image-img attachment-full" alt="" /></div>
															</div>
														</div>
													</div>
												</div>
			...
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p>Super Fashion
																	<!--&#8217;s-->knitting division in Sector 24, Faridabad is equipped with high speed automatic circular knitting machines with a capacity to manufacture 2,000 MT of fabrics per month. These machineries facilitate easy customization and Super Fashion creates innovative designs in fabrics for its global customers. Fabric production enables us to meet both in-house requirements and market needs.</p>
															</div>
														</div>
													</div>
												</div>
								...
								<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589458996906 grid_section" style=' text-align:left;'>
									<div class=" section_inner clearfix">
										<div class='section_inner_margin clearfix'>
			...
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_text_column wpb_content_element ">
															<div class="wpb_wrapper">
																<p><strong>Fabric Knitting Machines</strong></p>
																<ul>
																	<li>Interlock (Terrot)</li>
																	<li>Wrapper Autostriper (Camber)</li>
																	<li>Jersey with lycra (Terrot)</li>
																	<li>RIB cum Interlock (Terrot)</li>
																	<li>4 Colour Autostriper (Terrot)</li>
																	<li>Electronic Jacquard (Fukuhara and terrot)</li>
																</ul>
																<br/>
																<p><strong>Collar Knitting Machines:</strong></p>
																<ul>
																	<li>Mini Jacquard </li>
																	<li>Electronic Jacquard </li>
																</ul>
															</div>
														</div>
													</div>
			...
			<span class="empty_space_image"  ></span> </span>
					...
					background-color: ;
			">
																<img src="file/wp-content/uploads/2019/03/1610452461647.png" alt="initial image" />
