...
<head>
	...
	<title>Sewing Lines &#8211; Super Fashion</title>
	<style type="text/css" data-type="vc_shortcodes-custom-css">
	.vc_custom_1589522168807 {
		padding-top: 72px !important;
	}
	
	.vc_custom_1589459691475 {
	...
	.page-id-548.disabled_footer_top .footer_top_holder,
	.page-id-548.disabled_footer_bottom .footer_bottom_holder {
		display: none;
	}
	</style>
...
<body class="page-template page-template-full_width page-template-full_width-php page page-id-548 bridge-core-1.0.4  qode_grid_1300 footer_responsive_adv hide_top_bar_on_mobile_header qode-child-theme-ver-1.0.0 qode-theme-ver-18.0.6 qode-theme-bridge qode_header_in_grid wpb-js-composer js-comp-ver-6.0.5 vc_responsive" itemscope itemtype="http://schema.org/WebPage">
		...
		<div class="wrapper_inner">
				...
				<div class="content_inner  ">
									...
									<div class="container_inner clearfix">
										<div class="title_subtitle_holder">
											<div class="title_subtitle_holder_inner">
												<h1><span>Sewing Lines</span></h1>
												<h4 class="subtitle">We have capacity to produce nearly 1,50,000 garments per month.</h4> </div>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="full_width">
						<div class="full_width_inner">
							<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589522168807 grid_section" style=' text-align:left;'>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_single_image wpb_content_element vc_align_left">
														<div class="wpb_wrapper">
															<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="535" height="210" src="file/wp-content/uploads/2019/03/_MG_9901.jpg" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 535px) 100vw, 535px" /></div>
														</div>
													</div>
												</div>
											</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<h3 style="text-align: left;">Sewing Lines</h3> </div>
													</div>
													<div class="vc_empty_space" style="height: 12px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
													</div>
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<p style="text-align: left;">Super Fashion has more than 400 sewing machine in house and having a capaicity of more than 1,50,000 pieces per month and having more than 4000 employee working 24X7 to deliver best to our customer.</p>
														</div>
													</div>
													<div class="vc_empty_space" style="height: 12px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<p style="text-align: left;">Inspired by customer delight and the desire to make innovative designs, it creates mesmerizing fashion trends for mens, womens and kids. Entire garments produced are exclusively for international markets.</p>
														</div>
													</div>
												</div>
											</div>
							...
							<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589459691475 grid_section" style=' text-align:left;'>
								<div class=" section_inner clearfix">
									<div class='section_inner_margin clearfix'>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<p style="text-align: left;">We have inhouse design cell in the organiation to design the best development as per our customer need as well as to design new development as per new trends.</p>
														</div>
													</div>
												</div>
											</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_single_image wpb_content_element vc_align_left">
														<div class="wpb_wrapper">
															<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="535" height="210" src="file/wp-content/uploads/2019/03/UPshutterstock1096478189.jpg" class="vc_single_image-img attachment-full" alt="" sizes="(max-width: 535px) 100vw, 535px" /></div>
														</div>
													</div>
												</div>
											</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_single_image wpb_content_element vc_align_left">
														<div class="wpb_wrapper">
															<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="535" height="210" src="file/wp-content/uploads/2019/03/_MG_9889.jpg" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 535px) 100vw, 535px" /></div>
														</div>
													</div>
												</div>
											</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<h3 style="text-align: left;">Quality Control</h3> </div>
													</div>
													<div class="vc_empty_space" style="height: 12px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
													</div>
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<p style="text-align: left;">Inspection at every stage through well trained perosonnel to ensure stringent quality conformance<br> Exclusive dedicated and specialized customer service team for sustained and improve satisfactions <br> Mandatory uses of Hand gloves , hair net, mask, Aprons, etc. , by the employees for the twin benefit of safety and quality
														</div> 
													</div>
													<div class="vc_empty_space" style="height: 12px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
