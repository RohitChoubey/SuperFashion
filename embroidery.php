...
<head>
	...
	<title>Computer &#038; Embroidery &#8211; Super Fashion</title>
	<style type="text/css" data-type="vc_shortcodes-custom-css">
	.vc_custom_1542380940959 {
		padding-top: 84px !important;
	}
	
	.vc_custom_1589459406803 {
	...
	.page-id-542.disabled_footer_top .footer_top_holder,
	.page-id-542.disabled_footer_bottom .footer_bottom_holder {
		display: none;
	}
	</style>
	...
	<link rel='shortlink' href='index0d79.html?p=542' />
	<style type="text/css">
	.recentcomments a {
		display: inline !important;
		padding: 0 !important;
...
<body class="page-template page-template-full_width page-template-full_width-php page page-id-542 bridge-core-1.0.4  qode_grid_1300 footer_responsive_adv hide_top_bar_on_mobile_header qode-child-theme-ver-1.0.0 qode-theme-ver-18.0.6 qode-theme-bridge qode_header_in_grid wpb-js-composer js-comp-ver-6.0.5 vc_responsive" itemscope itemtype="http://schema.org/WebPage">
		...
		<?php 
				...
				<div class="content_inner  ">
									...
									<div class="container_inner clearfix">
										<div class="title_subtitle_holder">
											<div class="title_subtitle_holder_inner">
												<h1><span>Computer Embroidery</span></h1>
										    </div>
										</div>
									</div>
								</div>
					...
					<div class="full_width">
						<div class="full_width_inner">
							<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1542380940959 grid_section" style=' text-align:left;'>
											...
											<div class="vc_column-inner">
												<div class="wpb_wrapper">
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<h3 style="text-align: center;">COMPUTER EMBROIDERY</h3> </div>
													</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_single_image wpb_content_element vc_align_left">
														<div class="wpb_wrapper">
															<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="535" height="312" src="file/wp-content/uploads/2019/03/_MG_9857.jpg" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 535px) 100vw, 535px" /></div>
														</div>
													</div>
												</div>
											</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<div class="wpb_wrapper">
															<p style="text-align: center; margin-top:80px;">As the pioneer in the embroidery market, Super Fashion continues to design the highest quality embroidery job works using latest technology. Our printing and embroidery capabilities can create wonderful moments in our customers’ lives.</p>
														</div>
													</div>
													<div class="vc_empty_space" style="height: 12px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
			...
			<span class="empty_space_image"  ></span> </span>
							...
							<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589459406803 grid_section" style=' text-align:left;'>
								<div class=" section_inner clearfix">
									<div class='section_inner_margin clearfix'>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<h5>Our modern computer embroidery machinery includes:</h5> </div>
													</div>
													<div class="vc_empty_space" style="height: 12px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
													</div>
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<ul>
																<li>Barudan Computerized Embroidery- (9 Colours 20 Heads)</li>
																<li>Computerized Embroidery (With sequins/ cord /tape attachment ) 
</li>
																<li>Barudan Computerized Embroidery (9 Colours 4 Heads) </li>
															</ul>
														</div>
													</div>
												</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_single_image wpb_content_element vc_align_left">
														<div class="wpb_wrapper">
															<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="535" height="240" src="file/wp-content/uploads/2019/03/_MG_9861.jpg" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 535px) 100vw, 535px" /></div>
														</div>
													</div>
												</div>
											</div>
  ...
  <div class="row">
    <div class="col-sm-6" ><img style="height:500px; width:600px;" src ="file/wp-content/uploads/2019/03/_MG_9864.jpg" /></div>
    <div class="col-sm-6" ><img style="height:500px; width:600px;" src="file/wp-content/uploads/2019/03/_MG_9862.jpg"></div>
  </div>
</div>
