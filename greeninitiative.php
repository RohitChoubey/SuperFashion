...
<head>
	...
	<title>Green Initiative &#8211; Super Fashion</title>
	<style type="text/css" data-type="vc_shortcodes-custom-css">
	.vc_custom_1589524319932 {
		padding-top: 72px !important;
	}
	
	.vc_custom_1589461598799 {
	...
	.page-id-569.disabled_footer_top .footer_top_holder,
	.page-id-569.disabled_footer_bottom .footer_bottom_holder {
		display: none;
	}
	</style>
...
<body class="page-template page-template-full_width page-template-full_width-php page page-id-569 bridge-core-1.0.4  qode_grid_1300 footer_responsive_adv hide_top_bar_on_mobile_header qode-child-theme-ver-1.0.0 qode-theme-ver-18.0.6 qode-theme-bridge qode_header_in_grid wpb-js-composer js-comp-ver-6.0.5 vc_responsive" itemscope itemtype="http://schema.org/WebPage">
	...
	<div class="wrapper">
		<div class="wrapper_inner">
			...
			<a id="back_to_top" href="#"> <span class="fa-stack">
            <i class="qode_icon_font_awesome fa fa-arrow-up " ></i>        </span> </a>
				...
				<div class="content_inner  ">
									...
									<div class="container_inner clearfix">
										<div class="title_subtitle_holder">
											<div class="title_subtitle_holder_inner">
												<h1><span>Green Initiative</span></h1>
												<h4 class="subtitle">A Better and Green Planet</h4> </div>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="full_width">
						<div class="full_width_inner">
							<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589524319932 grid_section" style=' text-align:left;'>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_single_image wpb_content_element vc_align_left">
														<div class="wpb_wrapper">
															<div class="vc_single_image-wrapper   vc_box_border_grey"><img style="height:300px;"  src="file/wp-content/uploads/2019/03/1610544261115.jpeg" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 535px) 100vw, 535px" /></div>
														</div>
													</div>
												</div>
											</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<h3 style="text-align: left;">GREEN INITIATIVE</h3> </div>
													</div>
													<div class="vc_empty_space" style="height: 12px"><span class="vc_empty_space_inner">
			<span class="empty_space_image"  ></span> </span>
													</div>
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<p>Super Fashion is committed to preserving this beautiful planet of ours for future generations. All products are ethically sourced, processed and delivered; right from the use of organic cotton as raw material to the finished product and final delivery.</p>
															<p>&nbsp;</p>
															<p>The company follows a policy of effective waste management and pollution control to protect Mother Earth. Some of these initiatives include:</p>
															<ul>
																<li>Zero wastage. Zero pollution.</li>
																<li>100% commitment to environment protection.</li>
															</ul>
														</div>
													</div>
												</div>
							...
							<div class="vc_row wpb_row section vc_row-fluid  grid_section" style=' text-align:left;'>
								<div class=" section_inner clearfix">
									<div class='section_inner_margin clearfix'>
										<div class="wpb_column vc_column_container vc_col-sm-4 vc_col-lg-6 vc_col-md-6">
											<div class="vc_column-inner">
												<div class="wpb_wrapper">
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_single_image wpb_content_element vc_align_left">
														<div class="wpb_wrapper">
															<div class="vc_single_image-wrapper   vc_box_border_grey"><img style="height:300px;" src="file/wp-content/uploads/2019/03/20210113_185558.jpeg" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 535px) 100vw, 535px" /></div>
														</div>
													</div>
												</div>
											</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_single_image wpb_content_element vc_align_left">
														<div class="wpb_wrapper">
															<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="535" height="291" src="file/wp-content/uploads/2019/03/pexels-photo-236060.jpeg" style="height:300px;" class="vc_single_image-img attachment-full" alt="" sizes="(max-width: 535px) 100vw, 535px" /></div>
														</div>
													</div>
												</div>
											</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															...
															<p>&nbsp;</p>
															<p>KPR has imbibed greener values into the community. It has helped to promote bio-gas generation, which reduces the usage of LPG in the neighbouring community.</p>
															<p>.</p>
														</div>
													</div>
												</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_single_image wpb_content_element vc_align_left">
														<div class="wpb_wrapper">
															<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="535" height="291" src="file/wp-content/uploads/2020/03/Bio-Gas-Generation.jpg" class="vc_single_image-img attachment-full" alt="" srcset="https://kprmilllimited.com/file/wp-content/uploads/2020/03/Bio-Gas-Generation.jpg 535w, https://kprmilllimited.com/file/wp-content/uploads/2020/03/Bio-Gas-Generation-300x163.jpg 300w" sizes="(max-width: 535px) 100vw, 535px" /></div>
														</div>
													</div>
												</div>
											</div>
							...
							<!--<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589461598799 grid_section" style=' text-align:left;'>
								<div class=" section_inner clearfix">
									<div class='section_inner_margin clearfix'>
										<div class="wpb_column vc_column_container vc_col-sm-8 vc_col-lg-6 vc_col-md-6">
											<div class="vc_column-inner">
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_single_image wpb_content_element vc_align_left">
														<div class="wpb_wrapper">
															<div class="vc_single_image-wrapper   vc_box_border_grey"><img width="535" height="291" src="file/wp-content/uploads/2020/03/Afforestation.jpg" class="vc_single_image-img attachment-full" alt="" srcset="https://kprmilllimited.com/file/wp-content/uploads/2020/03/Afforestation.jpg 535w, https://kprmilllimited.com/file/wp-content/uploads/2020/03/Afforestation-300x163.jpg 300w" sizes="(max-width: 535px) 100vw, 535px" /></div>
														</div>
													</div>
												</div>
											</div>
			...
			<span class="empty_space_image"  ></span> </span>
													...
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<h5>Afforestation</h5>
															<p>&nbsp;</p>
															<p>Our concern for Mother Nature is what drives us to take special initiatives in planting more than 1,50,000 trees and diligently explore advanced scientific methods of afforestation.</p>
														</div>
													</div>
												</div>
											</div>
