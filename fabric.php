...
<head>
	...
	<title>Fabric &#8211; Super Fashion</title>
	<style type="text/css" data-type="vc_shortcodes-custom-css">
	.vc_custom_1589525267693 {
		padding-top: 72px !important;
	}
	
	.vc_custom_1589525356209 {
	...
	.page-id-510.disabled_footer_top .footer_top_holder,
	.page-id-510.disabled_footer_bottom .footer_bottom_holder {
		display: none;
	}
	</style>
	...
	<body class="page-template page-template-full_width page-template-full_width-php page page-id-510 bridge-core-1.0.4  qode_grid_1300 footer_responsive_adv hide_top_bar_on_mobile_header qode-child-theme-ver-1.0.0 qode-theme-ver-18.0.6 qode-theme-bridge qode_header_in_grid wpb-js-composer js-comp-ver-6.0.5 vc_responsive" itemscope itemtype="http://schema.org/WebPage">
	...
	<a id="back_to_top" href="#"> <span class="fa-stack">
					...
					<div class="content_inner  ">
						...
						<div class="full_width">
							<div class="full_width_inner">
								<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589525267693 grid_section" style=' text-align:left;'>
									<div class=" section_inner clearfix">
										...
										<?php 
											...
											$result = $db->query("SELECT * FROM product where category='fabric' ORDER BY id DESC LIMIT $start_from, $limit"); 
										?>
			...
			<span class="empty_space_image"  ></span> </span>
														...
														<div class="wpb_single_image wpb_content_element vc_align_left">
															<div class="wpb_wrapper">
																...
																<img style ="height:600px;" src="uploads/<?php echo($item['img'])?>" class="vc_single_image-img attachment-full" alt=""  sizes="(max-width: 634px) 100vw, 634px" /></div>

																<?php 
																if(isset($_SESSION['username'])){
																?>
																<form method = "post" action = "<?php $_PHP_SELF ?>" class="product-item__action-list button-stack" name ="delete"enctype="multipart/form-data" > 
																<input type="hidden" name="id" value="<?php echo($id); ?>">
																<button class="product-item__action-button button button--small button--primary" name = "delete" style="background-color:red; color:white;"><i class="fa fa-trash"></i>Delete Product</button>
															</form>
															<?php	
														}
																else{
										...
										<script language="JavaScript">
											alert('Image Deleteed Sucessfully !');
											document.location='kids.php';
										...
										<?php
											...
											$result_db = mysqli_query($db,"SELECT COUNT(id) FROM product where category='fabric'"); 
											...
											for ($i=1; $i<=$total_pages; $i++) {
														  $pagLink .= "<li class='page-item'><a class='page-link' href='fabric.php?page=".$i."'>".$i."</a></li>";	
											}
		...
		/* <![CDATA[ */
		var _wpmejsSettings = {
			"pluginPath": "\/file\/wp-includes\/js\/mediaelement\/",
			"classPrefix": "mejs-",
