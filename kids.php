								...
								<div class="vc_row wpb_row section vc_row-fluid  vc_custom_1589525267693 grid_section" style=' text-align:left;'>
									<div class=" section_inner clearfix">
										...
										<?php 
											...
											$result = $db->query("SELECT * FROM product where category='kid' ORDER BY id DESC LIMIT $start_from, $limit"); 
										?>
...
button--small button--primary" name = "delete" style="background-color:red; color:white;"><i class="fa fa-trash"></i>Delete Product</button>
										...
										<?php
											...
											$result_db = mysqli_query($db,"SELECT COUNT(id) FROM product where category='kid'"); 
											...
											for ($i=1; $i<=$total_pages; $i++) {
														  $pagLink .= "<li class='page-item'><a class='page-link' href='kids.php?page=".$i."'>".$i."</a></li>";	
											}
